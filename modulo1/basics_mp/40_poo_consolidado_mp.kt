// ABSTRACCIÓN: sealed class define los tipos posibles de notificación del sistema de eventos
...
class ServicioEmail : EnviadorNotificacion {
    ...
    override fun enviar(n: Notificacion): Boolean {
        ...
        println("  [EMAIL EVENTO] → ${n.destinatario}")
        return true
    }
}
...
class ServicioPush : EnviadorNotificacion {
    ...
    override fun enviar(n: Notificacion): Boolean {
        ...
        println("  [PUSH EVENTO] → ${n.dispositivo}")
        return true
    }
}
...
fun main() {
    ...
    listOf(
        Notificacion.Email("ana@evento.com", "Conferencia IA", "Tu inscripción fue confirmada."),
        Notificacion.Push("iPhone-Ana"),
        Notificacion.Sms("+34600000000", "Recordatorio: evento inicia en 1 hora."),
