void main() {
  // Lambda asignada a una variable — cálculo en sistema de eventos
  final cuadrado = (int n) => n * n;
  print(cuadrado(7));  // 49

  // Lambda de cuerpo completo — cálculo de descuento en entradas
  ...
  // Lambda en línea — orden de asistentes o registros
