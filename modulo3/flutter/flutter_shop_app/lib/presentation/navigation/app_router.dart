...
final routerProvider = Provider<GoRouter>((ref) {
  return GoRouter(
    initialLocation: '/',
@@ -59,7 +32,7 @@ final routerProvider = Provider<GoRouter>((ref) {
...
@@ -78,91 +51,75 @@ final routerProvider = Provider<GoRouter>((ref) {
      ShellRoute(
...
@@ -173,15 +130,4 @@ class _AuthStateListenable extends ChangeNotifier {
