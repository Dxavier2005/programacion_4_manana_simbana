...
class MpPantallaContexto extends StatelessWidget {
  const MpPantallaContexto({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          'Eventos App ${esMovil ? "móvil" : "tablet"} ${esRetrato ? "retrato" : "paisaje"}',
      ...
      body: ListView(
        ...
        children: [
          const _Seccion(
            titulo: 'Gestión de Conferencias App',
            items: [
              'Ancho:        375 px',
              'Alto:          667 px',
              'Pixel ratio:  2.0',
          ...
          const _Seccion(titulo: 'colorScheme', items: []),
          Wrap(
          ...
          const SizedBox(height: 16),
          const _Seccion(titulo: 'textTheme', items: []),
