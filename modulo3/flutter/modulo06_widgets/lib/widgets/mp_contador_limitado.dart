...
class MpContadorLimitado extends StatefulWidget {
  ...
  @override
  State<MpContadorLimitado> createState() => _MpContadorLimitadoState();
}

class _MpContadorLimitadoState extends State<MpContadorLimitado> {
  int _valor = 0;
        ...
        Row(
          ...
          children: [
            ...
            TextButton(
              ...
              child: const Text('Reiniciar aforo'),
            ),
          ],
        ),
        if (enLimite)
          Text(
            '¡Cupo máximo del evento alcanzado!',
