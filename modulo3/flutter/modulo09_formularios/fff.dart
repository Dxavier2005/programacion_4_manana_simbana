...
class _FormularioServidorState extends State<FormularioServidor> {
  ...
  final _ctrlDireccion_Mac      = TextEditingController();
  ...
  void _guardar() {
    ...
    widget.onGuardar({
      ...
      'ip':      _ctrlIp.text,
      'Direccion Mac':  _ctrlDireccion_Mac.text,
    ...
    return Form(
      ...
      child: Column(
        ...
        children: [
          ...
          // ── Dirección Mac ──────────────────────────────────────────
          TextFormField(
            controller:      _ctrlDireccion_Mac,
            focusNode:       _focusDireccion_Mac,
            decoration:      const InputDecoration(
            ...
            validator: (v) {
              ...
              if (!RegExp(r'^([0-9a-fA-F]{2}:){5}[0-9a-fA-F]{2}$').hasMatch(v))
                return 'Formato de dirección MAC inválido (ej. 00:11:22:33:44:55)';
              return null;
            },
          ),
          const SizedBox(height: 12),
          ...
          DropdownButtonFormField<String>(
            ...
            items: [
              ...
              'Rocky Linux 9', 'Alpine Linux', 'Postgres', 'MySql', 'Mongodb'
          ...
          DropdownButtonFormField<String>(
            value:      _so,
            decoration: const InputDecoration(
              labelText:  'Servicios Web',
              prefixIcon: Icon(Icons.web),
              border:     OutlineInputBorder(),
            ),
            items: [
              'Bases de datos', 'Servidor Web'
            ].map((s) => DropdownMenuItem(value: s, child: Text(s))).toList(),
            onChanged: (v) => setState(() => _so = v!),
          ),
