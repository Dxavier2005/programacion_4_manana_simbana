    ...
    <ScrollView
      ...
      <ThemedView style={styles.container}>
        <ThemedView style={styles.titleContainer}>
          <ThemedText type="subtitle">Veterinaria AP</ThemedText>
        ...
        <ThemedView style={styles.sectionsWrapper}>
          <Collapsible title="Gestión de mascotas">
          ...
          <Collapsible title="Registro de pacientes">
            <ThemedText type="small">
              Sistema de fichas médicas para mascotas con historial de vacunas,
              desparasitación, cirugías y más.
            </ThemedText>
